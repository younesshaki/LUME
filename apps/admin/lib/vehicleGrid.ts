...
export type VehicleImageFilter = "all" | "with" | "without";

export function normalizeVehicleImageFilter(value: string | undefined): VehicleImageFilter {
  return value === "with" || value === "without" ? value : "all";
}

export function vehicleHasImageSource(input: {
