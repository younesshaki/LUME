...
export const DEFAULT_CONCIERGE_TARGETS: readonly ConciergeTarget[] = [
  {
    ...
    destination: "/home",
    aiDescription:
      "The public website home page. Send visitors here when they ask to return home or see the dealership landing page.",
    isConversion: false,
    enabled: true,
    examplePrompts: ["Take me home", "Open the home page"],
    sortOrder: 10,
  },
  {
    id: null,
    ...
    aiDescription:
      "The public products and collaborations page. Send visitors here when they ask to browse LUME products or collaborations.",
    isConversion: false,
    enabled: true,
    examplePrompts: ["Take me to the products page", "Show me the collaborations"],
    sortOrder: 20,
  },
  {
    id: null,
  ...
  },
  {
    ...
    aiDescription:
      "The public cinematic showcase. Send visitors here when they explicitly ask to see the showcase or immersive experience.",
    isConversion: false,
    enabled: true,
    examplePrompts: ["Open the showcase", "Take me to the experience"],
    sortOrder: 50,
  },
  {
    id: null,
    ...
    destination: "/account",
    aiDescription:
      "The visitor account page for sign-in, saved vehicles, loyalty, and profile details.",
    isConversion: false,
    enabled: true,
    examplePrompts: ["Open my account", "Take me to my saved vehicles"],
    sortOrder: 60,
  },
  {
    id: null,
