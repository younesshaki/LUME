...
export function HoverBorderGradient({
  ...
  return (
    <Tag
      ...
      className={cn(
        "relative flex h-min w-fit flex-col flex-nowrap items-center justify-center gap-10 overflow-visible rounded-full border bg-black/20 p-px decoration-clone transition duration-500 hover:bg-black/10",
        containerClassName
      )}
      {...props}
    >
