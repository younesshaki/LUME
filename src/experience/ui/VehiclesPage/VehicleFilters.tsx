...
export function MarketplaceToolbar({
  ...
  return (
    <div
      className="vehiclesPage__toolbar"
      aria-label="Vehicle marketplace controls"
    >
      ...
      <label className="vehiclesPage__toolbarField vehiclesPage__toolbarField--optional">
        ...
        <select
          value={filters.make}
          onChange={(event) =>
            onFiltersChange({ make: event.target.value, model: "" })
          }
        >
        ...
        <div className="vehiclesPage__filterGrid">
            ...
            <div className="vehiclesPage__pillRow">
              {["New", "Used"].map((type) => (
                <PillButton
                  ...
                  onClick={() =>
                    onChange({
                      stockType: filters.stockType === type ? "" : type,
                    })
                  }
                />
              ))}
          ...
          <label className="vehiclesPage__filterGroup">
            ...
            <select
              ...
              onChange={(event) =>
                onChange({ sellerState: event.target.value, sellerCity: "" })
              }
            >
          ...
          <div className="vehiclesPage__filterGroup">
            ...
            <div className="vehiclesPage__rangeRow">
              <select
                ...
                onChange={(event) =>
                  onChange({ yearMin: Number(event.target.value) })
                }
              >
                {years.map((year) => (
              ...
              <select
                ...
                onChange={(event) =>
                  onChange({ yearMax: Number(event.target.value) })
                }
              >
                {years.map((year) => (
                  <option key={year} value={year}>
          ...
          <div className="vehiclesPage__filterGroup">
            ...
            <div className="vehiclesPage__rangeRow">
              <select
                ...
                onChange={(event) =>
                  onChange({ priceMin: Number(event.target.value) })
                }
              >
              ...
              <select
                ...
                onChange={(event) =>
                  onChange({ priceMax: Number(event.target.value) })
                }
              >
          ...
          <label className="vehiclesPage__filterGroup">
            ...
            <select
              ...
              onChange={(event) =>
                onChange({ mileageMax: Number(event.target.value) })
              }
            >
            ...
            <div className="vehiclesPage__pillRow">
              {DRIVETRAINS.map((drive) => (
                <PillButton
                  ...
                  onClick={() =>
                    onChange({
                      drivetrain: filters.drivetrain === drive ? "" : drive,
                    })
                  }
                />
              ))}
