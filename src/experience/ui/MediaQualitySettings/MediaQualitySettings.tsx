...
import { mediaQualitySoundActions } from "./MediaQualitySettings.sounds";
  ...
  return (
    <div ref={rootRef} className={`mediaQualitySettings${belowHeader ? " mediaQualitySettings--belowHeader" : ""}`}>
      <button
        ...
        aria-expanded={open}
        onMouseEnter={() => play(mediaQualitySoundActions.hover)}
        onClick={() => {
          play(mediaQualitySoundActions.open);
          setOpen((value) => !value);
        }}
      >
          ...
          {options.map((option) => {
            ...
            return (
              <button
                ...
                onMouseEnter={() => play(mediaQualitySoundActions.hover)}
                onClick={() => {
                  play(mediaQualitySoundActions.change);
