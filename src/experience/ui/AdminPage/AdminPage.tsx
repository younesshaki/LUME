...
import { adminPageSoundActions } from "./AdminPage.sounds";
    ...
    return (
      <div className="adminPage adminPage--denied">
        ...
        <button
          ...
          onMouseEnter={() => play(adminPageSoundActions.hover)}
          onClick={() => {
            play(adminPageSoundActions.exit);
            onExit();
          }}
        >
          Go home
          ...
          <div className="adminPage__sidebarHeader">
            ...
            {selectedUserId && (
              <button
                ...
                onMouseEnter={() => play(adminPageSoundActions.hover)}
                onClick={() => {
                  play(adminPageSoundActions.filterClear);
              ...
              return (
                ...
                >
                  <button
                    ...
                    onMouseEnter={() => play(adminPageSoundActions.profileHover)}
                    onClick={() => {
                      play(adminPageSoundActions.profileSelect);
